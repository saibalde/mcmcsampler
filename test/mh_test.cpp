...
TEST(McmcSampler, MetropolisHastings) {
  ...
  Eigen::MatrixXd samples =
      mcmcsampler::MH(num_dim, negative_log_pdf, proposal_covariance,
                      initial_sample, num_sample, rng);

  WriteMatrix(samples, "mh_test.dat");
}
